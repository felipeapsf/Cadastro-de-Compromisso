...
namespace Projeto.Services
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //injeção de dependencia para o repositorio
            services.AddDbContext<DataContext>(
                options => options.UseSqlServer
                (Configuration.GetConnectionString("exercicio02"))
                );

            services.AddTransient<ICompromissoRepository, CompromissoRepository>();
            ...
            services.AddSwaggerGen(
                swagger =>
                {
                    swagger.SwaggerDoc("v1",
                        new Info
                        {
                            Title = "API de controle de Compromissos",
                            Version = "v1",
